...
class Hps_Transit_StoredcardController extends Mage_core_Controller_Front_Action
{
    ...
    public function getBalanceAction()
    {
        try {
            ...
            $config->secretApiKey = Mage::getModel('hps_transit/payment')->getConfigData('secretapikey');
